...
class large_num {
	...
	int num_size;
		...
		//These are the changes made to the class on 6th of august

		//A simple mul_a function to multiply a largenum with interger and return 
		// a large num 

		large_num imult(largenum a){
